...
function bomberos_enqueue_scripts($hook)
{
    ...
    wp_enqueue_style('bomberos-styles', BOMBEROS_PLUGIN_URL . 'assets/css/bomberos-styles.css', [], time());
    wp_enqueue_script('bomberos-scripts', BOMBEROS_PLUGIN_URL . 'assets/js/bomberos-scripts.js', ['jquery'], time(), true);
